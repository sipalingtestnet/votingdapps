...
<br/>
<br/>
      <h1 className="text-center  text-xl font-bold mt-14" style={{ fontSize: '2.5rem' }}>
      Start Voting
    </h1>
    <br />
 

    <br /><div className="grid grid-cols-1 xl:grid-cols-2 pb-7 gap-[62px] sm:w-2/3 xl:w-5/6 mx-auto">
        {polls.map((poll, i) => (
      ...
      >
        ...
        >
          ...
          <button
            ...
            className="h-[44px] w-full rounded-full transition-all duration-300 bg-[#EF6C00] hover:bg-orange-500"
          >
            Enter
          </button>
        </div>
