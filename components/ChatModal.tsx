...
const ChatModal: React.FC<{ group: any }> = ({ group }) => {
  ...
  return (
    ...
    >
      <div className="bg-[#0c0c10] text-[#BBBBBB] shadow-lg shadow-[#EF6C00] rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
  ...
  return (
    <div className="flex justify-start space-x-4 px-6 mb-4 w-full">
      <div className="flex justify-start items-center w-full">
        <Identicon
          className="w-12 h-12 rounded-full object-cover mr-4 shadow-md bg-neutral-400"
          string={owner}
          size={30}
        />
        ...
        <div className="w-full">
          ...
          <p className="text-neutral-500 text-xs font-semibold space-x-2 w-4/5">{text}</p>
        </div>
      </div>
    </div>
  )
