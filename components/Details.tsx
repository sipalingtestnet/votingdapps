      ...
      >
        ...
        <div className=" h-[136px] gap-[16px] flex flex-col items-center mt-4">
          <div
            ...
            border-neutral-400 bg-white bg-opacity-20"
          >
          ...
          >
            <div className="w-[32px] h-[32px] rounded-full bg-[#EF6C00]" />
          ...
          <div className="h-[36px] gap-[4px] flex justify-center items-center">
            <button
              className="py-[6px] px-[12px] border border-neutral-400 bg-white bg-opacity-20
            ...
            <button
              ...
              border border-neutral-400 bg-white bg-opacity-20 rounded-full text-[12px] md:text-[16px]"
            >
          ...
          {poll.votes < 1 && (
            <button
              ...
              border border-neutral-400 bg-white hover:bg-opacity-20 hover:text-white py-2"
